...
**NOTE:** We do not have the code that were used to calculate the NIST PSCR specific metrics. We only received the final agreggated results.
...
**NOTE:** The data contains only a subset of the possible variables and the ACS PUMS is the 1940 Decennial Census data.
